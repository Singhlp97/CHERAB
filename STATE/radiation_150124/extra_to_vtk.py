...
in_directory = "/home/lovepreet/CHERAB_files/radiation_261022/radiation_load/input/Fabio/mesh_observing_extra/"
wall_points_files = ["target_up.extra", "target_down.extra", "target_left.extra", "target_right.extra"]

out_directory = in_directory + "/../mesh_observer_vtk/"
...
for wall_points_file in wall_points_files:
	...
	# file.close()
	export_vtk(wall_mesh, out_directory + basename + '_.vtk')
	export_obj(wall_mesh, out_directory + basename + '_.obj')
